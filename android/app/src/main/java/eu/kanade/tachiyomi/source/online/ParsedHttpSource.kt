...
/**
 * Port of extensions-lib ParsedHttpSource (Apache-2.0) — the Jsoup-selector
 * flavored HttpSource that theme extensions (Madara, MangaThemesia, ...)
 * subclass. Member signatures must match the lib exactly.
 */
