/*
 * Embedded copy of kohesive/injekt (Apache-2.0), api/Factory.kt.
...
interface InjektFactory {
    ...
    fun <R : Any> getLogger(expectedLoggerType: Type, forClass: Class<Any>): R
}

inline fun <R : Any> InjektFactory.get(forType: TypeReference<R>): R = getInstance(forType.type)
inline fun <R : Any> InjektFactory.getOrElse(forType: TypeReference<R>, default: R): R = getInstanceOrElse(forType.type, default)
inline fun <R : Any> InjektFactory.getOrElse(forType: TypeReference<R>, noinline default: () -> R): R = getInstanceOrElse(forType.type, default)
inline fun <R : Any> InjektFactory.getOrNull(forType: TypeReference<R>): R? = getInstanceOrNull(forType.type)
...
inline fun <R : Any> InjektFactory.getOrElse(forType: TypeReference<R>, key: Any, default: R): R = getKeyedInstanceOrElse(forType.type, key, default)
inline fun <R : Any> InjektFactory.getOrElse(forType: TypeReference<R>, key: Any, noinline default: () -> R): R = getKeyedInstanceOrElse(forType.type, key, default)
inline fun <R : Any> InjektFactory.getOrNull(forType: TypeReference<R>, key: Any): R? = getKeyedInstanceOrNull(forType.type, key)
...
inline fun <R : Any> InjektFactory.logger(expectedLoggerType: TypeReference<R>, forClass: Class<Any>): R = getLogger(expectedLoggerType.type, forClass)
inline fun <reified R : Any> InjektFactory.logger(forClass: Class<Any>): R = getLogger(fullType<R>().type, forClass)

inline fun <R : Any> InjektFactory.logger(expectedLoggerType: TypeReference<R>, forClass: KClass<Any>): R = getLogger(expectedLoggerType.type, forClass.java)
inline fun <reified R : Any> InjektFactory.logger(forClass: KClass<Any>): R = getLogger(fullType<R>().type, forClass.java)
