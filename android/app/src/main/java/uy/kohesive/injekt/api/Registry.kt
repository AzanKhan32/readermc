/*
 * Embedded copy of kohesive/injekt (Apache-2.0), api/Registry.kt.
...
inline fun <reified O : Any, reified T : O> InjektRegistry.addAlias() = addAlias(fullType<T>(), fullType<O>())
